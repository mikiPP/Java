...
import CrystalExpender.CrystalExpender;
import Receptivo.Receptivo;
import RickMenu.RickMenu;
import UfosPark.UfosPark;
...
//
        ...
        System.out.println("stock: " + rickMenu.getStock());
        rickMenu.getBuyersNames();


        System.out.println("\nCreditos de los invitados/as \n" +
                "==========================================");

        rickMenu.displayBuyers();
