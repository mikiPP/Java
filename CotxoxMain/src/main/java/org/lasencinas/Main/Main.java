...
public class Main {
    ...
    public static void main(String[] args) {
         ...
         * La flota es un objeto de tipo PoolConductores.PoolConductores.
         */
        ...
        // Creamos el objeto flota de conductores, de la clase PoolConductores.PoolConductores.
