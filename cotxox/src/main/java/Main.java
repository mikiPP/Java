...
public class Main {
    ...
    public static void main(String[] args) {
         ...
         * y de la Carrera.Carrera.Carrera.Carrera.
         *
         */
         ...
         * La flota es un objeto de tipo PoolConductores.PoolConductores.PoolConductores.PoolConductores.
         */

        HashSet<Conductor> poolConductores = new HashSet<Conductor>();
        ...
        // Creamos el objeto flota de conductores, de la clase PoolConductores.PoolConductores.PoolConductores.PoolConductores.
