...
public class App {
    ...
    public static void main( String[] args )
    {
        ...
        System.out.println("\n" + "Vamos a implementar la reventa con enziniums " + "\n");
        ...
        System.out.println("Balance de Morty " + morty.getBalance());

        jen.send(ricknillos,10d,morty);
        ...
        System.out.println( "\n" + "Consultamos si la reventa se ha realizado con exito" + "\n" +
                        "===============" );
        ricknillos.owners();
        System.out.println("Owner: " + rick.getPK().hashCode() + " "
                + ricknillos.balanceOf(rick.getPK())
